...
architecture behave of myproject_axi_AXILiteS_s_axi is
    ...
    signal int_out_V_address1  : UNSIGNED(2 downto 0);
...
-- ----------------------- Memory logic ------------------
    ...
    -- out_V
    int_out_V_address0   <= SHIFT_RIGHT(UNSIGNED(out_V_address0), 1)(2 downto 0);
    ...
    int_out_V_address1   <= raddr(4 downto 2) when ar_hs = '1' else waddr(4 downto 2);
