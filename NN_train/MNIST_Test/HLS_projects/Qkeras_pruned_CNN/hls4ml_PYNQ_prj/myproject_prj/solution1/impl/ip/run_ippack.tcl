...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {}
        memories "in_V {base_address 2048 range 2048} out_V {base_address 4096 range 32}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 5 machine 64 combinational 0 latency 196777 II x}
