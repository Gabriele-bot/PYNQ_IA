...
set hdl_module_list {myproject_axi_mux_255_9_1_1
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {}
        memories "in_V {base_address 1024 range 1024} out_V {base_address 2048 range 32}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 5 machine 64 combinational 0 latency 66676 II x}
