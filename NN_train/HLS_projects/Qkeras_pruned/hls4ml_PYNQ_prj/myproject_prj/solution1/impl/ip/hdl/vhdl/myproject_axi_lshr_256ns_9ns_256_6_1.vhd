...
entity myproject_axi_lshr_256ns_9ns_256_6_1 is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 256;  --data bitwidth
      din1_WIDTH : INTEGER := 256;    --shift control bitwidth
      dout_WIDTH : INTEGER := 256;  --output bitwidth
...
end entity myproject_axi_lshr_256ns_9ns_256_6_1;
architecture rtl of myproject_axi_lshr_256ns_9ns_256_6_1 is
