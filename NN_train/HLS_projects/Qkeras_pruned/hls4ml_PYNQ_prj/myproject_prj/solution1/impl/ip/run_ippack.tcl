...
set solution_dir "/home/gabri-bot/University/Git_hub/PYNQ_IA/NN_train/HLS_projects/Qkeras_pruned/hls4ml_PYNQ_prj/myproject_prj/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {myproject_axi_lshr_256ns_9ns_256_6_1
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {}
        memories "in_V {base_address 32 range 32} out_V {base_address 64 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 5 machine 64 combinational 0 latency 136 II x}
